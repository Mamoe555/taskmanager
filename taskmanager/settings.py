...
SECRET_KEY = os.environ.get('SECRET_KEY', 'm-jcq5+63ptwwc1xufy00^6*$w^f%em1)#tqh&oa#p_*nmc+p4')

# SECURITY: Debug mode should be False in production
DEBUG = os.environ.get('DEBUG', 'False').lower() == 'true'

# Add your Render domain and any other production domains
...
# Use PostgreSQL on Render (if DATABASE_URL environment variable exists)
